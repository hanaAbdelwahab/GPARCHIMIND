from ai.inference.file_generator import (
    generate_event_driven_project_files,
    generate_nfr_files,
...
def generate_event_driven(functional, nfrs, patterns,
    language="python"):
...
"""
    ...
    try:
        ...
        parsed = generate_event_driven_project_files(requirements,language)
    ...
    try:
        ...
        print("EVENT DRIVEN NFR ERROR:", e)
    ...
    try:
        ...
        print("EVENT DRIVEN PATTERN ERROR:", e)
