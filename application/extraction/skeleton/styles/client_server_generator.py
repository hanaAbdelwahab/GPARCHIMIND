from ai.inference.file_generator import (
    generate_client_server_project_files,
    generate_nfr_files,
...
def generate_client_server(functional, nfrs, patterns,language="python"):
...
"""
    ...
    try:
        ...
        parsed = generate_client_server_project_files(requirements,language)
    ...
    try:
        ...
        print("CLIENT SERVER NFR ERROR:", e)
    ...
    try:
        ...
        print("CLIENT SERVER PATTERN ERROR:", e)
